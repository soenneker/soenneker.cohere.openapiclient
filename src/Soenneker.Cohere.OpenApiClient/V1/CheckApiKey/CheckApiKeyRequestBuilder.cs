...
using System;
namespace Soenneker.Cohere.OpenApiClient.V1.CheckApiKey
{
    /// <summary>
    /// Builds and executes requests for operations under \v1\check-api-key
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class CheckApiKeyRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Cohere.OpenApiClient.V1.CheckApiKey.CheckApiKeyRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CheckApiKeyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/check-api-key", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Cohere.OpenApiClient.V1.CheckApiKey.CheckApiKeyRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CheckApiKeyRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/check-api-key", rawUrl)
        {
        }
        /// <summary>
        /// Checks that the api key in the Authorization header is valid and active
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Cohere.OpenApiClient.Models.CheckApiKey200Response"/></returns>
...
#nullable enable
        public async Task<global::Soenneker.Cohere.OpenApiClient.Models.CheckApiKey200Response?> PostAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Cohere.OpenApiClient.Models.CheckApiKey200Response> PostAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Cohere.OpenApiClient.Models.CheckApiKey200Response>(requestInfo, global::Soenneker.Cohere.OpenApiClient.Models.CheckApiKey200Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Checks that the api key in the Authorization header is valid and active
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Cohere.OpenApiClient.V1.CheckApiKey.CheckApiKeyRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Cohere.OpenApiClient.V1.CheckApiKey.CheckApiKeyRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Cohere.OpenApiClient.V1.CheckApiKey.CheckApiKeyRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
