...
namespace Soenneker.Cohere.OpenApiClient.V1.Datasets.Usage
{
    ...
    public partial class UsageRequestBuilder : BaseRequestBuilder
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Cohere.OpenApiClient.Models.GetDatasetUsage200Response"/></returns>
...
#nullable enable
        public async Task<global::Soenneker.Cohere.OpenApiClient.Models.GetDatasetUsage200Response?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Cohere.OpenApiClient.Models.GetDatasetUsage200Response> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Cohere.OpenApiClient.Models.GetDatasetUsage200Response>(requestInfo, global::Soenneker.Cohere.OpenApiClient.Models.GetDatasetUsage200Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// View the dataset storage usage for your Organization. Each Organization can have up to 10GB of storage across all their users.
        /// </summary>
