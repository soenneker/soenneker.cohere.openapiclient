...
namespace Soenneker.Cohere.OpenApiClient.V2.Audio.Transcriptions
{
    ...
    public partial class TranscriptionsRequestBuilder : BaseRequestBuilder
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Cohere.OpenApiClient.Models.CreateTranscription200Response"/></returns>
...
#nullable enable
        public async Task<global::Soenneker.Cohere.OpenApiClient.Models.CreateTranscription200Response?> PostAsync(MultipartBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Cohere.OpenApiClient.Models.CreateTranscription200Response> PostAsync(MultipartBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Cohere.OpenApiClient.Models.CreateTranscription200Response>(requestInfo, global::Soenneker.Cohere.OpenApiClient.Models.CreateTranscription200Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Transcribe an audio file.
        /// </summary>
