...
using System;
namespace Soenneker.Cohere.OpenApiClient.V2.Parse
{
    /// <summary>
    /// Builds and executes requests for operations under \v2\parse
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class ParseRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Cohere.OpenApiClient.V2.Parse.ParseRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ParseRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v2/parse", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Cohere.OpenApiClient.V2.Parse.ParseRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ParseRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v2/parse", rawUrl)
        {
        }
        /// <summary>
        /// Parse a document image into structured output. Use `output_format` to selectblocks or markdown (default).Currently supports `document.type = image_url` only (data URI or remote http(s)image URL). PDF / file URL inputs are not yet supported.Image limits: 20 MB file size; 50 megapixels or 200 MB decoded (whichever isexceeded first).
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Cohere.OpenApiClient.Models.ParseResponse"/></returns>
...
#nullable enable
        public async Task<global::Soenneker.Cohere.OpenApiClient.Models.ParseResponse?> PostAsync(global::Soenneker.Cohere.OpenApiClient.Models.Parsev2Request body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Cohere.OpenApiClient.Models.ParseResponse> PostAsync(global::Soenneker.Cohere.OpenApiClient.Models.Parsev2Request body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Cohere.OpenApiClient.Models.ParseResponse>(requestInfo, global::Soenneker.Cohere.OpenApiClient.Models.ParseResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Parse a document image into structured output. Use `output_format` to selectblocks or markdown (default).Currently supports `document.type = image_url` only (data URI or remote http(s)image URL). PDF / file URL inputs are not yet supported.Image limits: 20 MB file size; 50 megapixels or 200 MB decoded (whichever isexceeded first).
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Soenneker.Cohere.OpenApiClient.Models.Parsev2Request body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Soenneker.Cohere.OpenApiClient.Models.Parsev2Request body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Cohere.OpenApiClient.V2.Parse.ParseRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Cohere.OpenApiClient.V2.Parse.ParseRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Cohere.OpenApiClient.V2.Parse.ParseRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
